                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <input type="text" name="name" id="name" class="form-control" placeholder="الاسم" style="text-align: right"/>
                                          </div>
                                      </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingOne">
                                            <h4 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="text-align: right; padding-right: 70px; font-size: 30px">سهولة الاستخدام</a>
                                            </h4>
                                        </div>
                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                <p style="float: right; font-size: 23px"> احصل على خدمة النقل التي تلبي احتياجك بضغطة زر</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="text-align: right; padding-right: 70px; font-size: 30px">الثقة والإحترافية</a>
                                            </h4>
                                        </div>
                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                            <div class="panel-body">
                                                <p style="float: right; font-size: 23px">نحرص في إقلال على توفير خدمات نقل مضمونة ذات جودة عالية</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingThree">
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="text-align: right; padding-right: 70px; font-size: 30px">الدقة والالتزام</a>
                                            </h4>
                                        </div>
                                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                            <div class="panel-body">
                                                <p style="float: right; font-size: 23px">مع اقلال ليس عليك أن تقلق من التأخر عن محاضراتك ومواعيدك </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingFour">
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseThree" style="text-align: right; padding-right: 70px; font-size: 30px">مزودي نقل مختلفين</a>
                                            </h4>
                                        </div>
                                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                            <div class="panel-body">
                                                <p style="float: right; font-size: 23px">شركات نقل خاصة أو سائق خاص؟ أي ما تفضل ستجده متوفر مع اقلال </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
